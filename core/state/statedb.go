...
// Package state provides a caching layer atop the Ubetprotocol state trie.
package state
...
// StateDBs within the ubetprotocol protocol are used to store anything
...
//
// Carrying over the balance ensures that Ubetcoin doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/ubetprotocol/go-ubetprotocol/pull/16485#issuecomment-380438527),
