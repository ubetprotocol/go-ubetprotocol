...
var (
	...
	authorsFileHeader = "# This is the official list of go-ubetprotocol authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ubetprotocol Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-ubetprotocol"
	}
	if startOfSentence {
		return "The go-ubetprotocol library"
	}
	return "the go-ubetprotocol library"
}
