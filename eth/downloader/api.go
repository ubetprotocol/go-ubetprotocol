...
// Syncing provides information when this nodes starts synchronising with the Ubetprotocol network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ubetprotocol.SyncProgress `json:"status"`
}
