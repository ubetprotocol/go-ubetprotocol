...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Ubetprotocol presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gubet wallet import /path/to/my/presale.wallet

will prompt for your password and imports your ubetcoin presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Ubetprotocol presale wallet",
				ArgsUsage: "<keyFile>",
...
between ubetprotocol nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another ubetprotocol instance,
