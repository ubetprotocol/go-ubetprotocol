...
// mapped from textual names used in the tests below to actual Ubetprotocol private
...
// address retrieves the Ubetprotocol address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Ubetprotocol address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/ubetprotocol/go-ubetprotocol/issues/17593). Whilst this
