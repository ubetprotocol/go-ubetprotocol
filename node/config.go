...
import (
	...
	"github.com/ubetprotocol/go-ubetprotocol/accounts/external"
	"github.com/ubetprotocol/go-ubetprotocol/accounts/keystore"
	"github.com/ubetprotocol/go-ubetprotocol/accounts/scwallet"
	"github.com/ubetprotocol/go-ubetprotocol/accounts/usbwallet"
...
func makeAccountManager(conf *Config) (*accounts.Manager, string, error) {
	...
	if keydir == "" {
		// There is no datadir.
		keydir, err = ioutil.TempDir("", "go-ubetprotocol-keystore")
		ephemeral = keydir
	}
