...
!define HELPURL "https://github.com/ubetprotocol/go-ubetprotocol/issues"
!define UPDATEURL "https://github.com/ubetprotocol/go-ubetprotocol/releases"
!define ABOUTURL "https://github.com/ubetprotocol/go-ubetprotocol#ubetprotocol-go"
...
Section "Gubet" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Gubet incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gubet outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gubet UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gubet incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ubetprotocol" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gubet outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ubetprotocol" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gubet UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ubetprotocol" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ubetprotocol/EIPs/issues/147)
