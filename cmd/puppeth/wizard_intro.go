...
// setting up a new or managing an existing Ubetprotocol private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Ubetprotocol private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ubetprotocol network down to  |")
	...
	log.Info("Administering Ubetprotocol network", "name", w.network)
