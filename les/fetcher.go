...
// the necessary amount to request and whubetcoin a downloader sync is necessary instead of a normal header request.
...
// adds it to the end of a linked list togubetcoin with the time it has been confirmed. Then checks which peers have
