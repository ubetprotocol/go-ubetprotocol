...
type Context struct {
	// CanTransfer returns whubetcoin the account contains
	// sufficient ubetcoin to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers ubetcoin from one account to the other
...
// EVM is the Ubetprotocol Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) ubetprotocol virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whubetcoin the max code size has been exceeded
