...
// Package p2p implements the Ubetprotocol p2p network protocols.
package p2p
...
import (
	...
	"github.com/ubetprotocol/go-ubetprotocol/p2p/discover"
	"github.com/ubetprotocol/go-ubetprotocol/p2p/discv5"
	"github.com/ubetprotocol/go-ubetprotocol/p2p/enode"
	"github.com/ubetprotocol/go-ubetprotocol/p2p/enr"
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "ubetprotocol discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if tcp, ok := listener.Addr().(*net.TCPAddr); ok {
		...
		if !tcp.IP.IsLoopback() && srv.NAT != nil {
			srv.loopWG.Add(1)
			go func() {
				nat.Map(srv.NAT, srv.quit, "tcp", tcp.Port, tcp.Port, "ubetprotocol p2p")
				srv.loopWG.Done()
			}()
		}
	}
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Ubetprotocol Node Record
