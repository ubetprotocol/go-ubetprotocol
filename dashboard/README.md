## Go Ubetprotocol Dashboard

The dashboard is a data visualizer integrated into gubet, intended to collect and visualize useful information of an Ubetprotocol node. It consists of two parts:
...
As the dashboard depends on certain NPM packages (which are not included in the `go-ubetprotocol` repo), these need to be installed first:
