...
// Contains a wrapper for the Ubetprotocol client.
...
// UbetprotocolClient provides access to the Ubetprotocol APIs.
type UbetprotocolClient struct {
	client *ethclient.Client
}

// NewUbetprotocolClient connects a client to the given URL.
func NewUbetprotocolClient(rawurl string) (client *UbetprotocolClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &UbetprotocolClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *UbetprotocolClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *UbetprotocolClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *UbetprotocolClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *UbetprotocolClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *UbetprotocolClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *UbetprotocolClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *UbetprotocolClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *UbetprotocolClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *UbetprotocolClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *UbetprotocolClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *UbetprotocolClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *UbetprotocolClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *UbetprotocolClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *UbetprotocolClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *UbetprotocolClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *UbetprotocolClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *UbetprotocolClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *UbetprotocolClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *UbetprotocolClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *UbetprotocolClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *UbetprotocolClient) SendTransaction(ctx *Context, tx *Transaction) error {
