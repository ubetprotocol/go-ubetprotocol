...
// ecrecover extracts the Ubetprotocol account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Ubetprotocol address
...
// Ubetprotocol testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Ubetprotocol address of the signing key
...
// Author implements consensus.Engine, returning the Ubetprotocol address recovered
