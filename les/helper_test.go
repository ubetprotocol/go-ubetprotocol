...
import (
	...
	"github.com/ubetprotocol/go-ubetprotocol/accounts/abi/bind/backends"
...
func prepareTestchain(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some ubetcoin to user1
		...
		case 1:
			...
			// bankUser transfers more ubetcoin to user1
			...
			// user1 relays ubetcoin to user2
		...
		case 2:
			// bankUser transfer some ubetcoin to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
