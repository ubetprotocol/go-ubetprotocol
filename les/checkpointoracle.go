...
type checkpointOracle struct {
	...
	// Whubetcoin the contract backend is set.
	running int32
...
// isRunning returns an indicator whubetcoin the registrar is running.
...
// checks whubetcoin there are enough approvals to finalize the checkpoint.
