...
// Package types contains data types related to Ubetprotocol consensus.
package types
...
// Header represents a block header in the Ubetprotocol blockchain.
type Header struct {
...
// Block represents an entire block in the Ubetprotocol blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Ubetprotocol
...
// EncodeRLP serializes b into the Ubetprotocol RLP block format.
