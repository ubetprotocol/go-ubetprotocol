...
type wizard struct {
	...
	services map[string][]string   // Ubetprotocol services known to be running on servers
...
// converts it to an Ubetprotocol address. If an empty line is entered, the default
// value is returned.
