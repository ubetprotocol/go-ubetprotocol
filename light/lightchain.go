...
// for the Ubetprotocol Light Client.
package light
...
type LightChain struct {
	...
	running          int32 // whubetcoin LightChain is running or stopped
	procInterrupt    int32 // interrupts chain insert
	disableCheckFreq int32 // disables header verification
}

// NewLightChain returns a fully initialised light chain using information
// available in the database. It initialises the default Ubetprotocol header
// validator.
...
//
// The verify parameter can be used to fine tune whubetcoin nonce verification
