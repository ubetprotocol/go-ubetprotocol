 ...
 * @author Gary Rong<garyrong@ubetprotocol.org>, Martin Swende <martin.swende@ubetprotocol.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the ubetprotocol.
    uint sectionSize;
