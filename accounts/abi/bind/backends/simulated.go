...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Ubetprotocol blockchain to handle the consensus
...
// blockchain. The isPending return value indicates whubetcoin the transaction has been
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call ubetprotocol.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call ubetprotocol.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call ubetprotocol.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call ubetprotocol.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query ubetprotocol.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query ubetprotocol.FilterQuery, ch chan<- types.Log) (ubetprotocol.Subscription, error) {
