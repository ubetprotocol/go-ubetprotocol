...
// Whisper represents a dark communication interface through the Ubetprotocol
...
// New creates a Whisper client ready to communicate through the Ubetprotocol P2P network.
