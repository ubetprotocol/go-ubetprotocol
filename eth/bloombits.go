...
import (
	...
	"github.com/ubetprotocol/go-ubetprotocol/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Ubetprotocol
...
func (eth *Ubetprotocol) startBloomHandlers(sectionSize uint64) {
...
// for the Ubetprotocol header bloom filters, permitting blazing fast filtering.
