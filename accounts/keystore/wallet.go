...
// Status implements accounts.Wallet, returning whubetcoin the account held by the
...
func (w *keystoreWallet) SelfDerive(bases []accounts.DerivationPath, chain ubetprotocol.ChainStateReader) {
}
