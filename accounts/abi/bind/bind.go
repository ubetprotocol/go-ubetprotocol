...
// Package bind generates Ubetprotocol contract Go bindings.
//
// Detailed usage document and tutorial available on the go-ubetprotocol Wiki page:
// https://github.com/ubetprotocol/go-ubetprotocol/wiki/Native-DApps:-Go-bindings-to-Ubetprotocol-contracts
package bind
...
// structured checks whubetcoin a list of ABI data types has enough information to
