...
// Verify that Client implements the ubetprotocol interfaces.
var (
	_ = ubetprotocol.ChainReader(&Client{})
	_ = ubetprotocol.TransactionReader(&Client{})
	_ = ubetprotocol.ChainStateReader(&Client{})
	_ = ubetprotocol.ChainSyncReader(&Client{})
	_ = ubetprotocol.ContractCaller(&Client{})
	_ = ubetprotocol.GasEstimator(&Client{})
	_ = ubetprotocol.GasPricer(&Client{})
	_ = ubetprotocol.LogFilterer(&Client{})
	_ = ubetprotocol.PendingStateReader(&Client{})
	// _ = ubetprotocol.PendingStateEventer(&Client{})
	_ = ubetprotocol.PendingContractCaller(&Client{})
)
...
func TestToFilterArg(t *testing.T) {
	...
	for _, testCase := range []struct {
		name   string
		input  ubetprotocol.FilterQuery
		output interface{}
		err    error
	}{
		{
			"without BlockHash",
			ubetprotocol.FilterQuery{
				Addresses: addresses,
