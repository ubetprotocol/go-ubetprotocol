...
import (
	...
	"github.com/ubetprotocol/go-ubetprotocol/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Ubetprotocol service within
	...
	ethConf := &eth.Config{
		...
		Miner: miner.Config{
			Ubetcoinbase: common.HexToAddress(testAddress),
		},
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return eth.New(ctx, ethConf) }); err != nil {
		t.Fatalf("failed to register Ubetprotocol protocol: %v", err)
	}
	...
	stack.Service(&ubetprotocol)

	return &tester{
		workspace: workspace,
		stack:     stack,
		ubetprotocol:  ubetprotocol,
		console:   console,
		input:     prompter,
		output:    printer,
	}
