...
// Package graphql provides a GraphQL interface to Ubetprotocol node data.
package graphql
...
// Account represents an Ubetprotocol account at a particular block.
type Account struct {
...
// Transaction represents an Ubetprotocol transaction.
...
// Block represents an Ubetprotocol block.
...
type CallData struct {
	From     *common.Address // The Ubetprotocol address the call is from.
	To       *common.Address // The Ubetprotocol address the call is to.
...
type SyncState struct {
	progress ubetprotocol.SyncProgress
}
