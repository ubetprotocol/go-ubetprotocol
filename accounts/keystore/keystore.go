...
// See https://github.com/ubetprotocol/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whubetcoin the event notification loop is running
...
// HasAddress reports whubetcoin a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Ubetprotocol presale wallet and stores
