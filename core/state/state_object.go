...
// stateObject represents an Ubetprotocol account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ubetprotocol address of the account
	data     Account
	db       *StateDB
...
// Account is the Ubetprotocol consensus representation of accounts.
