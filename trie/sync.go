...
type request struct {
	...
	raw  bool        // Whubetcoin this is a raw entry (code) or a trie node
...
func (s *Sync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback LeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togubetcoin
...
func (s *Sync) children(req *request, object node) ([]*request, error) {
	// Gather all the children of the node, irrelevant whubetcoin known or not
	type child struct {
		node  node
		depth int
	}
