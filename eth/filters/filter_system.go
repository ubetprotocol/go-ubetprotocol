...
// Package filters implements an ubetprotocol filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  ubetprotocol.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit ubetprotocol.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit ubetprotocol.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit ubetprotocol.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit ubetprotocol.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
