...
RUN \
	sed -i 's/PuppethNetworkID/{{.NetworkID}}/g' dist/js/ubetcoinwallet-master.js && \
	sed -i 's/PuppethNetwork/{{.Network}}/g'     dist/js/ubetcoinwallet-master.js && \
	sed -i 's/PuppethDenom/{{.Denom}}/g'         dist/js/ubetcoinwallet-master.js && \
	sed -i 's/PuppethHost/{{.Host}}/g'           dist/js/ubetcoinwallet-master.js && \
	sed -i 's/PuppethRPCPort/{{.RPCPort}}/g'     dist/js/ubetcoinwallet-master.js
...
// checkWallet does a health-check against web wallet server to verify whubetcoin
// it's running, and if yes, whubetcoin it's responsive.
