...
import "github.com/ubetprotocol/go-ubetprotocol/accounts/abi"
...
type tmplMethod struct {
	...
	Structured bool       // Whubetcoin the returns should be accumulated into a struct
}
...
import (
	...
	ubetprotocol "github.com/ubetprotocol/go-ubetprotocol"
	"github.com/ubetprotocol/go-ubetprotocol/accounts/abi"
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new Ubetprotocol contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around an Ubetprotocol contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Caller is an auto generated read-only Go binding around an Ubetprotocol contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around an Ubetprotocol contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around an Ubetprotocol contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an Ubetprotocol contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an Ubetprotocol contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an Ubetprotocol contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around an Ubetprotocol contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around an Ubetprotocol contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around an Ubetprotocol contract.
	...
	{{range .Events}}
		...
		type {{$contract.Type}}{{.Normalized.Name}}Iterator struct {
			...
			sub  ubetprotocol.Subscription // Subscription for errors, completion and termination
			done bool                  // Whubetcoin the subscription completed delivering logs
			fail error                 // Occurred error to stop iteration
		}
		// Next advances the iterator to the subsequent event, returning whubetcoin there
...
public class {{.Type}} {
	...
	// deploy deploys a new Ubetprotocol contract, binding an instance of {{.Type}} to it.
	public static {{.Type}} deploy(TransactOpts auth, UbetprotocolClient client{{range .Constructor.Inputs}}, {{bindtype .Type}} {{.Name}}{{end}}) throws Exception {
	...
	// Ubetprotocol address where this contract is located at.
	public final Address Address;

	// Ubetprotocol transaction in which this contract was deployed (if known!).
	...
	public {{.Type}}(Address address, UbetprotocolClient client) throws Exception {
