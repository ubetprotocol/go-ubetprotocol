...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Ubetprotocol address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Ubetprotocol account at a particular block.
    type Account {
    ...
    # Log is an Ubetprotocol event log.
    type Log {
    ...
    # Transaction is an Ubetprotocol transaction.
    type Transaction {
    ...
    # Block is an Ubetprotocol block.
    type Block {
        ...
        # Account fetches an Ubetprotocol account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Ubetprotocol account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Ubetprotocol block by number or by hash. If neither is
