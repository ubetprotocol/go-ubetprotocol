...
// Service implements an Ubetprotocol netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Ubetprotocol      // Full Ubetprotocol service if monitoring a full node
	les    *les.LightUbetprotocol // Light Ubetprotocol service if monitoring a light node
...
func New(url string, ethServ *eth.Ubetprotocol, lesServ *les.LightUbetprotocol) (*Service, error) {
